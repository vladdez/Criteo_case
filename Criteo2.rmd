...
df  %>% filter(`Event type` == 'Sales', `Browser family` != 'NULL', `Browser family` != 'other') %>%
  ...
  ggplot(aes(y = Usage, x = reorder(`Browser family`, Usage), label = Usage , fill = reorder(`Browser family`, Usage))) + 
  geom_col() +
...
**Recommendation:** technical specialist should check and resolve problems with adding a product in a basket in Android app
